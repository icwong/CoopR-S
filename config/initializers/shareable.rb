Shareable.configure do |config|
  ...
  config.kid_directed_site='true' # 'true' or 'false'. '' defaults to 'false'. Facebook assumes your site is not kid friendly.
  ...
  config.pin_color='white' # 'red', 'white' or 'gray'. '' defaults to 'gray'.
